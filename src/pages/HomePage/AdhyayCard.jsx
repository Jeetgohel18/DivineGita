...
const AdhyayCard = ({ chapter }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="card text-base cursor-pointer bg-[#fde047] text-3c415c p-[0.75rem] m-[0.95rem] border-2 border-white rounded-[15px] flex flex-col justify-between items-start max-w-[350px] h-[250px] font-Nunito text-lg leading-[1.6]"
    >
